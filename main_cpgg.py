...
from models import cpgg
from engine_cpgg import train_one_epoch
from dataset import UKBCMR_cachedTrain
import copy
...
def get_args_parser():
    parser = argparse.ArgumentParser('cpgg training', add_help=False)
    parser.add_argument('--batch_size', default=16, type=int,
                        help='Batch size per GPU (effective batch size is batch_size * # gpus')
    parser.add_argument('--epochs', default=400, type=int)

    # Model parameters
    parser.add_argument('--model', default='cpgg', type=str, metavar='MODEL',
                        help='Name of model to train')

    # VAE parameters
    parser.add_argument('--img_size', default=(50, 96, 96), type=parse_tuple,
    ...
    parser.add_argument('--vae_stride', default=(2, 8, 8), type=parse_tuple,help='tokenizer stride, default use KL16')
    parser.add_argument('--patch_size', default=(5, 2, 2), type=parse_tuple, help='number of tokens to group as a patch.')
    ...
    parser.add_argument('--cached_path', default='', type=str, help='path to cached latents')

    # condition
    parser.add_argument('--cond', action='store_true', help='use metrics condition')
...
def main(args):
    ...
    dataset_train = UKBCMR_cachedTrain(cached_path=args.cached_path)
    ...
    model = cpgg.__dict__[args.model](
